...
// https://github.com/commonsguy/cwac-provider/blob/master/provider/src/main/java/com/commonsware/cwac/provider/LegacyCompatCursorWrapper.java

public class FPCursorWrapper extends CursorWrapper {
     ...
     */
    public FPCursorWrapper(Cursor cursor) {
        this(cursor, null);
    }
     ...
     *                 we need it
     */
    public FPCursorWrapper(Cursor cursor, String mimeType) {
