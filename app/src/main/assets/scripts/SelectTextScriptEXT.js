...
function getFullWord(x,y) {
    ...
    if (isNaN(word)) {
        ...
        highlightDiv.style.backgroundColor = '#00BFFF';
...
var x1 = XCOORD * (window.innerWidth / WIDTH);
var y1 = YCOORD * (window.innerHeight / HEIGTH);

//var word = getWordUnderCursor(x1,y1);

var el = document.elementFromPoint(x1,y1);
var word = getWordAtPoint(el,x1,y1);
//var word = getFullWord(x1,y1);
